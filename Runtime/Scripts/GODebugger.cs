...
public class GODebugger : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isHoldingDebugKey)
        {
            ...
            {
                Repository.Instance.Viewers.UpdateViewer(new PTViewer() { Id = "test-viewer", RootNodeId = "GUID 67a20f8a-a0ca-4c00-9a1a-18819f96d56e", Scale = new Vector3(2, 2, 2), Position = new Vector3(0, 2, 0), Rotation = new Quaternion(0, 0, 0, 0) });
            }
